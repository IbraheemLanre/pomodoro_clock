...
export const BreakSessionContainer = ({children, ...props}) => {
    return(
        <div className= "fle flex-col items-center" {...props}>
            {children}
        </div>
    );
};
...
export const BreakSessionLabel = ({children, ...props}) => {
    return (
    <p className="text-lg text-green-200">{children}</p>
    );
};
...
export const PlusMinusButtonContainer = ({children, ...props}) => {
    return (
    <div className="grid grid-flow-col gap-2 rounded" {...props}>{children}</div>
    );
};